...
class ChatViewController: UIViewController, UITableViewDelegate , UITableViewDataSource , UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(tappedViewTapped))
        messageTableView.addGestureRecognizer(tapGesture)
        

        //TODO: Register your MessageCell.xib file here:
        let messageCellNib = UINib(nibName: "MessageCell", bundle: nil)
        messageTableView.register(messageCellNib, forCellReuseIdentifier: "customMessageCell")
        configureTableView()
        retrieveMessages()
